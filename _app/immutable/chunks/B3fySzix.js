var W=Object.defineProperty;var N=o=>{throw TypeError(o)};var Z=(o,e,t)=>e in o?W(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var z=(o,e,t)=>Z(o,typeof e!="symbol"?e+"":e,t),$=(o,e,t)=>e.has(o)||N("Cannot "+t);var J=(o,e,t)=>e.has(o)?N("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t);var A=(o,e,t)=>($(o,e,"access private method"),t);import"./CWj6FrbW.js";import{o as ee,s as te}from"./Dk1ub_2X.js";import{p as ne,as as oe,J as r,aD as se,K as H,L as y,a as v,f as ae,d as ie,r as le,Y as re,b as _,M as O,c as ce,G as de,t as me}from"./DXl8ODdu.js";import{p as L,i as q}from"./BuRgqgNv.js";import{h as he}from"./CYSIQ6V0.js";import{s as pe,t as ge,e as _e}from"./gO1DupgE.js";import{b as P,C as ue}from"./CfeaUy-c.js";import{b as be}from"./BkKNNs0a.js";const Me={json_complex:{name:"json_complex",lang:"json",content:`{
	"string": "a string",
	"number": 12345,
	"boolean": true,
	"null": null,
...
`}},fe={token_processing_instruction:1,token_doctype:1,token_cdata:1,token_punctuation:1,token_tag:2,token_constant:2,token_symbol:2,token_deleted:2,token_keyword:2,token_null:2,token_boolean:2,token_interpolation_punctuation:2,token_heading:2,token_heading_punctuation:2,token_tag_punctuation:2,token_comment:3,token_char:3,token_inserted:3,token_blockquote:3,token_blockquote_punctuation:3,token_builtin:4,token_class_name:4,token_number:4,token_attr_value:5,token_attr_quote:5,token_string:5,token_template_punctuation:5,token_inline_code:5,token_code_punctuation:5,token_attr_equals:6,token_selector:7,token_function:7,token_regex:7,token_important:7,token_variable:7,token_atrule:8,token_attr_name:9,token_property:9,token_decorator:9,token_decorator_name:9,token_link_text_wrapper:9,token_link_text:9,token_link_punctuation:9,token_special_keyword:10,token_namespace:10,token_rule:10,token_at_keyword:11,token_url:11,token_strikethrough:13,token_bold:14,token_italic:15},B=()=>{var o;return!!((o=globalThis.CSS)!=null&&o.highlights&&globalThis.Highlight)};var E,D;class ke{constructor(){J(this,E);z(this,"element_ranges");if(!B())throw Error("CSS Highlights API not supported");this.element_ranges=new Map}highlight_from_syntax_tokens(e,t){var g;let s=null;for(const n of e.childNodes)if(n.nodeType===Node.TEXT_NODE){s=n;break}if(!s)throw new Error("no text node to highlight");this.clear_element_ranges();const c=new Map,h=A(this,E,D).call(this,t,s,c,0),a=((g=s.textContent)==null?void 0:g.length)??0;if(h!==a)throw new Error(`Token stream length mismatch: tokens covered ${h} chars but text node has ${a} chars`);for(const[n,d]of c){const l=`token_${n}`;this.element_ranges.set(l,d);let i=CSS.highlights.get(l);i||(i=new Highlight,i.priority=fe[l]??0,CSS.highlights.set(l,i));for(const p of d)i.add(p)}}clear_element_ranges(){for(const[e,t]of this.element_ranges){const s=CSS.highlights.get(e);if(!s)throw new Error("Expected to find CSS highlight: "+e);for(const c of t)s.delete(c);s.size===0&&CSS.highlights.delete(e)}this.element_ranges.clear()}destroy(){this.clear_element_ranges()}}E=new WeakSet,D=function(e,t,s,c){var g;const h=((g=t.textContent)==null?void 0:g.length)??0;let a=c;for(const n of e){if(typeof n=="string"){a+=n.length;continue}const d=n.length,l=a+d;if(l>h)throw new Error(`Token ${n.type} extends beyond text node: position ${l} > length ${h}`);try{const i=new Range;i.setStart(t,a),i.setEnd(t,l);const p=n.type;s.has(p)||s.set(p,[]),s.get(p).push(i);for(const u of n.alias){s.has(u)||s.set(u,[]);const b=new Range;b.setStart(t,a),b.setEnd(t,l),s.get(u).push(b)}}catch(i){throw new Error(`Failed to create range for ${n.type}: ${i}`)}if(Array.isArray(n.content)){const i=A(this,E,D).call(this,n.content,t,s,a);if(i!==l)throw new Error(`Token ${n.type} length mismatch: claimed ${d} chars (${a}-${l}) but nested content covered ${i-a} chars (${a}-${i})`);a=i}else a=l}return a};var ye=ae("<code><!></code>");function je(o,e){ne(e,!0);const t=L(e,"lang",3,"svelte"),s=L(e,"mode",3,"auto"),c=L(e,"inline",3,!1),h=L(e,"syntax_styler",3,pe);let a=se(void 0);const g=B(),n=g?new ke:null,d=H(()=>g&&(s()==="ranges"||s()==="auto")),l=H(()=>c()?"span":"pre"),i=H(()=>t()!==null&&!!h().langs[t()]),p=H(()=>t()===null||!r(i)&&!e.grammar),u=H(()=>r(d)||!e.content||r(p)?"":h().stylize(e.content,t(),e.grammar));n&&oe(()=>{if(!r(a)||!e.content||!r(d)||r(p)){n.clear_element_ranges();return}const C=ge(e.content,e.grammar||h().get_lang(t()));n.highlight_from_syntax_tokens(r(a),C)}),ee(()=>{n==null||n.destroy()});var b=y(),F=v(b);_e(F,()=>r(l),!1,(C,G)=>{P(C,m=>({...e.pre_attrs,"data-lang":t(),[ue]:m}),[()=>({code:!0,inline:c(),pre:c()})],void 0,"svelte-9jvl7a");var x=ye();P(x,()=>({...e.code_attrs}),void 0,void 0,"svelte-9jvl7a");var I=ie(x);{var R=m=>{var w=y(),M=v(w);O(M,()=>e.children,()=>e.content),_(m,w)},U=m=>{var w=y(),M=v(w);{var K=f=>{var S=de();me(()=>te(S,e.content)),_(f,S)},V=f=>{var S=y(),X=v(S);{var Y=k=>{var T=y(),j=v(T);O(j,()=>e.children,()=>r(u)),_(k,T)},Q=k=>{var T=y(),j=v(T);he(j,()=>r(u)),_(k,T)};q(X,k=>{e.children?k(Y):k(Q,!1)},!0)}_(f,S)};q(M,f=>{r(d)||r(p)?f(K):f(V,!1)},!0)}_(m,w)};q(I,m=>{r(d)&&e.children?m(R):m(U,!1)})}le(x),be(x,m=>re(a,m),()=>r(a)),_(G,x)}),_(o,b),ce()}export{je as C,Me as s};
