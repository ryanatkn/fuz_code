var V=Object.defineProperty;var D=n=>{throw TypeError(n)};var W=(n,e,t)=>e in n?V(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var N=(n,e,t)=>W(n,typeof e!="symbol"?e+"":e,t),X=(n,e,t)=>e.has(n)||D("Cannot "+t);var z=(n,e,t)=>e.has(n)?D("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t);var j=(n,e,t)=>(X(n,e,"access private method"),t);import{f as Q,a as u,d as S,t as Y}from"./DlUSUuuE.js";import{o as Z}from"./P58BwoFi.js";import{p as $,v as ee,J as r,ah as te,K as C,c as ne,r as oe,W as se,a as ae,f as T,t as ie}from"./Brg_2F-A.js";import{s as le}from"./p6G_AVMl.js";import{p as H,r as re,i as A}from"./Dx_bBUwt.js";import{s as J,h as ce}from"./7HYJ4EGG.js";import{b as me,C as de}from"./Bd_5h5Vr.js";import{b as he}from"./DeLDTU9B.js";import{s as pe,t as ge}from"./B5WxmWAY.js";const Ce={json_complex:{name:"json_complex",lang:"json",content:`{
	"string": "a string",
	"number": 12345,
	"boolean": true,
	"null": null,
...
`}},_e={token_processing_instruction:1,token_doctype:1,token_cdata:1,token_punctuation:1,token_tag:2,token_constant:2,token_symbol:2,token_deleted:2,token_keyword:2,token_null:2,token_boolean:2,token_interpolation_punctuation:2,token_heading:2,token_heading_punctuation:2,token_tag_punctuation:2,token_comment:3,token_char:3,token_inserted:3,token_blockquote:3,token_blockquote_punctuation:3,token_builtin:4,token_class_name:4,token_number:4,token_attr_value:5,token_attr_quote:5,token_string:5,token_template_punctuation:5,token_inline_code:5,token_code_punctuation:5,token_attr_equals:6,token_selector:7,token_function:7,token_regex:7,token_important:7,token_variable:7,token_atrule:8,token_attr_name:9,token_property:9,token_decorator:9,token_decorator_name:9,token_link_text_wrapper:9,token_link_text:9,token_link_punctuation:9,token_special_keyword:10,token_namespace:10,token_rule:10,token_at_keyword:11,token_url:11,token_strikethrough:13,token_bold:14,token_italic:15},O=()=>{var n;return!!((n=globalThis.CSS)!=null&&n.highlights&&globalThis.Highlight)};var E,q;class ue{constructor(){z(this,E);N(this,"element_ranges");if(!O())throw Error("CSS Highlights API not supported");this.element_ranges=new Map}highlight_from_syntax_tokens(e,t){var p;let a=null;for(const s of e.childNodes)if(s.nodeType===Node.TEXT_NODE){a=s;break}if(!a)throw new Error("no text node to highlight");this.clear_element_ranges();const m=new Map,h=j(this,E,q).call(this,t,a,m,0),l=((p=a.textContent)==null?void 0:p.length)??0;if(h!==l)throw new Error(`Token stream length mismatch: tokens covered ${h} chars but text node has ${l} chars`);for(const[s,d]of m){const i=`token_${s}`;this.element_ranges.set(i,d);let o=CSS.highlights.get(i);o||(o=new Highlight,o.priority=_e[i]??0,CSS.highlights.set(i,o));for(const g of d)o.add(g)}}clear_element_ranges(){for(const[e,t]of this.element_ranges){const a=CSS.highlights.get(e);if(!a)throw new Error("Expected to find CSS highlight: "+e);for(const m of t)a.delete(m);a.size===0&&CSS.highlights.delete(e)}this.element_ranges.clear()}destroy(){this.clear_element_ranges()}}E=new WeakSet,q=function(e,t,a,m){var p;const h=((p=t.textContent)==null?void 0:p.length)??0;let l=m;for(const s of e){if(typeof s=="string"){l+=s.length;continue}const d=s.length,i=l+d;if(i>h)throw new Error(`Token ${s.type} extends beyond text node: position ${i} > length ${h}`);try{const o=new Range;o.setStart(t,l),o.setEnd(t,i);const g=s.type;a.has(g)||a.set(g,[]),a.get(g).push(o);for(const _ of s.alias){a.has(_)||a.set(_,[]);const b=new Range;b.setStart(t,l),b.setEnd(t,i),a.get(_).push(b)}}catch(o){throw new Error(`Failed to create range for ${s.type}: ${o}`)}if(Array.isArray(s.content)){const o=j(this,E,q).call(this,s.content,t,a,l);if(o!==i)throw new Error(`Token ${s.type} length mismatch: claimed ${d} chars (${l}-${i}) but nested content covered ${o-l} chars (${l}-${o})`);l=o}else l=i}return l};var be=Q("<code><!></code>");function Le(n,e){$(e,!0);const t=H(e,"lang",3,"svelte"),a=H(e,"mode",3,"auto"),m=H(e,"inline",3,!1),h=H(e,"wrap",3,!1),l=H(e,"syntax_styler",3,pe),p=re(e,["$$slots","$$events","$$legacy","content","lang","mode","grammar","inline","wrap","syntax_styler","children"]);let s=te(void 0);const d=O(),i=d?new ue:null,o=C(()=>d&&(a()==="ranges"||a()==="auto")),g=C(()=>t()!==null&&!!l().langs[t()]),_=C(()=>t()===null||!r(g)&&!e.grammar),b=C(()=>r(o)||!e.content||r(_)?"":l().stylize(e.content,t(),e.grammar));i&&ee(()=>{if(!r(s)||!e.content||!r(o)||r(_)){i.clear_element_ranges();return}const c=ge(e.content,e.grammar||l().get_lang(t()));i.highlight_from_syntax_tokens(r(s),c)}),Z(()=>{i==null||i.destroy()});var y=be();me(y,c=>({...p,"data-lang":t(),[de]:c}),[()=>({inline:m(),wrap:h()})],void 0,"svelte-a0qsi5");var P=ne(y);{var B=c=>{var x=S(),L=T(x);J(L,()=>e.children,()=>e.content),u(c,x)},F=c=>{var x=S(),L=T(x);{var I=f=>{var v=Y();ie(()=>le(v,e.content)),u(f,v)},R=f=>{var v=S(),U=T(v);{var G=k=>{var w=S(),M=T(w);J(M,()=>e.children,()=>r(b)),u(k,w)},K=k=>{var w=S(),M=T(w);ce(M,()=>r(b)),u(k,w)};A(U,k=>{e.children?k(G):k(K,!1)},!0)}u(f,v)};A(L,f=>{r(o)||r(_)?f(I):f(R,!1)},!0)}u(c,x)};A(P,c=>{r(o)&&e.children?c(B):c(F,!1)})}oe(y),he(y,c=>se(s,c),()=>r(s)),u(n,y),ae()}export{Le as C,Ce as s};
