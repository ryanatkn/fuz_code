...
<LibraryItem name={LIBRARY_ITEM_NAME}>
	<div class="prose">
		<section>
			<p>
				The <LibraryVocab name="Code" /> component supports syntax highlighting with
...
<Card>
  <div class="greeting">hi {friend}</div>
		...
		<section>
			...
			<aside>
				please note: performing syntax highlighting at runtime like this does is wasteful, and the
				API is a work-in-progress for efficiency - you can use <code>lang={'{'}null}</code> with
